        ...
        copy: {
            python: {
                files: [{expand: true, src: ['src/app/*/python/*.py',
                    ...
                    {expand: true,
                      src: ['src/app/listPolicy/python/fetch_policy.py',
                           'src/app/createPolicy/python/updatepolicy.py',
                           'src/app/listPolicy/python/querypolicy.py'],
                         dest: 'build/cgi_cli', flatten: true},
                    {expand: true,
